 ...
 * Analytics Service
 *
 * Macro-level workout analytics: aggregated metrics, consistency stats,
 * and muscle distribution. Per-exercise queries live in
 * exerciseAnalyticsService.ts (TD-003 extraction).
 *
 * Conventions:
...
import { SESSION_VOLUME_COALESCE } from '../utils/sqlFragments';
import {
    MetricType,
    TimeBucket,
    ChartRange,
